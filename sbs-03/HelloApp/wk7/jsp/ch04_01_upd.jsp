...
<body>
	<form action="${url}/student?flag=update" method="post">
		<table border="0" width="238" height="252">
			...
			<tr><td>体重</td><td><input type="text" name="weight" value="${student.weight }"></td></tr>
			<tr><td>身高</td><td><input type="text" name="hight" value="${student.weight }"></td></tr>
			<tr align="center">
				<td colspan="2">
